...
import { controllerInserirFuncionario } from '../controller/gerente.js'

export const route_gerente = express.Router();

route_gerente.post('/inserirFuncionario', validarAccessMiddlware, autenticar, confirmarPermissoesGerente, dadosUsuario, controllerInserirFuncionario
);